 ...
 * @version $Revision: 1.21 $ ($Author: fgiust $)
 */
public class AttributeTable
{
    ...
    private static final Attribute[] ATTRS = {
        ...
        new Attribute("yst", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystset", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ysttest", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystupto", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystidref", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystparams", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystaux", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
        new Attribute("ystbool", Dict.VERS_LOOSE, AttrCheckImpl.TEXT), // Yeast, added by Fran
    };
