...
import org.w3c.tidy.yst.TidyMessage.Level;
 ...
 * @version $Revision: 1.49 $ ($Author: fgiust $)
 */
public final class Report
{
    ...
    static
    {
        try
        {
            res = ResourceBundle.getBundle("org/w3c/tidy/yst/TidyMessages");
        }
    ...
    {
        if (lexer.configuration.onlyErrors && level != Level.ERROR) // ** Added by Fran 10-07-2008
          return;
