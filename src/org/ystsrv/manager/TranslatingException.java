 ...
 * @version 1.0
 */
public class TranslatingException extends YSTException {
  public TranslatingException() {
    super();
  }

  public TranslatingException(String msg) {
    super(msg);
  }

  public TranslatingException(Throwable ex) {
    super(ex);
  }

  public TranslatingException(String msg, Throwable ex) {
    super(msg, ex);
  }
}
