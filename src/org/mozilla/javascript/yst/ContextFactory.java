...
public class ContextFactory
{
     ...
     */
    protected org.mozilla.javascript.yst.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return org.mozilla.javascript.yst.xml.XMLLib.Factory.create(
                "org.mozilla.javascript.yst.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return org.mozilla.javascript.yst.xml.XMLLib.Factory.create(
                "org.mozilla.javascript.yst.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
