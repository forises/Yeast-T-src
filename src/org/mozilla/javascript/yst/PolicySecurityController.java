...
import org.mozilla.classfile.yst.ByteCode;
import org.mozilla.classfile.yst.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lorg/mozilla/javascript/yst/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "org/mozilla/javascript/yst/Callable", "call",
                "(" + callableCallSig);
