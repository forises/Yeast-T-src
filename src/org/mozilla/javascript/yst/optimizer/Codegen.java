...
import org.mozilla.classfile.yst.*;
import java.util.*;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "org.mozilla.javascript.yst.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("org/mozilla/javascript/yst/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org/mozilla/javascript/yst/BaseFunction",
                      "createObject",
                      "(Lorg/mozilla/javascript/yst/Context;"
                      +"Lorg/mozilla/javascript/yst/Scriptable;"
                      +")Lorg/mozilla/javascript/yst/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "org/mozilla/javascript/yst/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "org/mozilla/javascript/yst/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org/mozilla/javascript/yst/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg/mozilla/javascript/yst/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org/mozilla/javascript/yst/ScriptRuntime",
                      "doTopCall",
                      "(Lorg/mozilla/javascript/yst/Callable;"
                      +"Lorg/mozilla/javascript/yst/Context;"
                      +"Lorg/mozilla/javascript/yst/Scriptable;"
                      +"Lorg/mozilla/javascript/yst/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lorg/mozilla/javascript/yst/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org/mozilla/javascript/yst/NativeFunction",
                      "initScriptFunction",
                      "(Lorg/mozilla/javascript/yst/Context;"
                      +"Lorg/mozilla/javascript/yst/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "org/mozilla/javascript/yst/RegExpProxy",
                              "compileRegExp",
                              "(Lorg/mozilla/javascript/yst/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lorg/mozilla/javascript/yst/Context;"
                      +")Lorg/mozilla/javascript/yst/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "org/mozilla/javascript/yst/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "org/mozilla/javascript/yst/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lorg/mozilla/javascript/yst/Context;"
                  +"Lorg/mozilla/javascript/yst/Scriptable;"
                  +"Lorg/mozilla/javascript/yst/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lorg/mozilla/javascript/yst/Scriptable;"
          +"Lorg/mozilla/javascript/yst/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "org/mozilla/javascript/yst/Scriptable",
                          "getParentScope",
                          "()Lorg/mozilla/javascript/yst/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lorg/mozilla/javascript/yst/NativeFunction;"
                               +"Lorg/mozilla/javascript/yst/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lorg/mozilla/javascript/yst/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lorg/mozilla/javascript/yst/NativeFunction;"
                               +"Lorg/mozilla/javascript/yst/Scriptable;"
                               +"Lorg/mozilla/javascript/yst/Scriptable;II"
                               +")Lorg/mozilla/javascript/yst/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lorg/mozilla/javascript/yst/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "org/mozilla/javascript/yst/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lorg/mozilla/javascript/yst/Context;"
                    +")Lorg/mozilla/javascript/yst/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lorg/mozilla/javascript/yst/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lorg/mozilla/javascript/yst/Scriptable;"
                            +"Lorg/mozilla/javascript/yst/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lorg/mozilla/javascript/yst/Callable;"
                            +"Lorg/mozilla/javascript/yst/Scriptable;"
                            +"Lorg/mozilla/javascript/yst/Context;"
                            +"Lorg/mozilla/javascript/yst/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "org/mozilla/javascript/yst/Callable",
                "call",
                "(Lorg/mozilla/javascript/yst/Context;"
                +"Lorg/mozilla/javascript/yst/Scriptable;"
                +"Lorg/mozilla/javascript/yst/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "org/mozilla/javascript/yst/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "org/mozilla/javascript/yst/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "org/mozilla/javascript/yst/EcmaError";
