...
import org.mozilla.javascript.yst.debug.DebuggableScript;
import org.mozilla.javascript.yst.debug.Debugger;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "org.mozilla.javascript.yst.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class cl = listener.getClass();
            Class factoryClass = Kit.classOrNull(
                "org.mozilla.javascript.yst.ContextFactory");
     ...
     *
     * @see org.mozilla.javascript.yst.ErrorReporter
     */
     ...
     * @see org.mozilla.javascript.yst.SecurityController
     */
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.mozilla.javascript.yst.Script
     */
    ...
    private static Class codegenClass = Kit.classOrNull(
                             "org.mozilla.javascript.yst.optimizer.Codegen");
    private static Class interpreterClass = Kit.classOrNull(
                             "org.mozilla.javascript.yst.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class cl = Kit.classOrNull(
                          "org.mozilla.javascript.yst.regexp.RegExpImpl");
            if (cl != null) {
